...
/*
*** Function done by us ***
	Rather than creating a bloom from the error, as the error is what we want to measure we shall create the bloom, from 
	the size of the bloom we want to create.
*/
int bloom_init_m(struct bloom * bloom, int entries, int m);
